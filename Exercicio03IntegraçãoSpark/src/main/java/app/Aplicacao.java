	...
	public class Aplicacao {
	    ...
	    public static void main(String[] args) {
	       ...
	       //port(5432);
			...
			public void makeForm(int tipo, Carro produto, int orderBy) {
				...
				List<Carro> produtos;
				if (orderBy == FORM_ORDERBY_ID) {                 	produtos = CarroDAO.getOrderByID();
				} else if (orderBy == FORM_ORDERBY_DESCRICAO) {		produtos = CarroDAO.getOrderByDescricao();
				} else if (orderBy == FORM_ORDERBY_PRECO) {			produtos = CarroDAO.getOrderByPreco();
				} else {											produtos = CarroDAO.get();
				}

				int i = 0;
				String bgcolor = "";
				for (Carro p : produtos) {
			...
			public Object insert(Request request, Response response) {
				...
				Carro produto = new Carro(-1, descricao, preco, quantidade, dataFabricacao, dataValidade);
				
				if(CarroDAO.insert(produto) == true) {
			...
			public Object get(Request request, Response response) {
				...
				Carro produto = (Carro) CarroDAO.get(id);
